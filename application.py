...
def sportJSON(sport_id):
    ...
    item = session.query(Item).filter_by(sport_id=sport_id).all()
    return jsonify(Item=[i.serialize for i in item])


@app.route('/sports/<int:sport_id>/item/<int:item_id>/JSON')
...
def showAllSports():
    ...
    return render_template('main.html', sport=sport)


# Returns all items for the particular sport
@app.route('/sports/<int:sport_id>/item')
def showItem(sport_id):
    sport = session.query(Sport).filter_by(id=sport_id).one()
    item = session.query(Item).filter_by(sport_id=sport_id)
    return render_template('item.html', sport=sport,
                           item=item, sport_id=sport_id)


# Create new item for the particular sport
@app.route('/sports/<int:sport_id>/item/new', methods=['GET', 'POST'])
...
# Edit existing item for the particular sport
@app.route('/sports/<int:sport_id>/item/<int:item_id>/edit',
           methods=['GET', 'POST'])
...
# Delete existing item for the particular sport
@app.route('/sports/<int:sport_id>/item/<int:item_id>/delete',
           methods=['GET', 'POST'])
